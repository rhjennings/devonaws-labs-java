...
public abstract class SolutionCode implements ILabCode, IOptionalLabCode {
    ...
    public void createAccountItem(AmazonDynamoDBClient ddbClient, String tableName, Account account) {
        // TODO: Create a HashMap<String, AttributeValue> object to hold the attributes of the item to add.
    	Map<String, AttributeValue> itemAttributes = new HashMap<String, AttributeValue>();
    	// TODO: Add the required items (Company and Email) from the account parameter to the attribute HashMap. 
    	...
    	// TODO: Check the account parameter and add all values that aren't empty strings ("") to the attribute HashMap.
        ...
        // TODO: Construct a PutItemRequest object to put the attributes into the specified table.
        PutItemRequest putItemRequest = new PutItemRequest().withTableName(tableName).withItem(itemAttributes);

        // TODO: Submit the request using the putItem method of the ddbClient object.
    ...
    public QueryResult lookupByHashKey(AmazonDynamoDBClient ddbClient, String tableName, String company) {
        // TODO: Construct an AttributeValue object containing the provided company name.
        AttributeValue attributeValue = new AttributeValue().withS(company);
        // TODO: Construct a Condition object containing the desired comparison ("EQ") and the attribute value containing the company name. 
        Condition condition = new Condition().withComparisonOperator("EQ").withAttributeValueList(attributeValue);
        
        // TODO: Construct a QueryRequest object that performs a consistent read on the specified table for the previously constructed condition.
        ...
        // TODO: Submit the query by calling the query method of the ddbClient object and return the result. 
    ...
    public void updateIfMatch(AmazonDynamoDBClient ddbClient, String tableName, String email, String company, 
        ...
        // TODO: Construct an UpdateItemRequest object for the specified table.
    	UpdateItemRequest updateItemRequest = new UpdateItemRequest().withTableName(tableName);

    	// TODO: Add KeyEntry elements to the request containing AttributeValue objects for the company name and email address provided.
    	...
    	// TODO: Add an ExpectedEntry element to the request containing an ExpectedAttributeValue object that contains the value in the firstNameMatch parameter. 
    	updateItemRequest.addExpectedEntry("First", 
    			new ExpectedAttributeValue().withValue(
    					new AttributeValue().withS(firstNameMatch)));
    
    	// TODO: Add an AttributeUpdatesEntry element to the request containing an AttributeValueUpdate object that contains the value in the firstNameTarget parameter
        ...
        // TODO: Submit the request using the updateItem method of the ddbClient object. 
    ...
    public void buildTable(AmazonDynamoDBClient ddbClient, String tableName) {
        ...
        // Define attributes
        createTableRequest.getAttributeDefinitions().add(new AttributeDefinition().withAttributeName("Company").withAttributeType("S"));
        createTableRequest.getAttributeDefinitions().add(new AttributeDefinition().withAttributeName("Email").withAttributeType("S"));
        // Define key schema
        ...
        createTableRequest.setProvisionedThroughput(new ProvisionedThroughput().withReadCapacityUnits(10L).withWriteCapacityUnits(5L));
