...
import awslabs.lab22.ILabCode;
import awslabs.lab22.IOptionalLabCode;
import awslabs.lab22.StudentCode;
...
public class Lab22 {
	...
	/**
	 * Validate the table matches the expected schema for the lab. Since it's
	 * built by hand, there's a decent chance that it may not be what's
	 * expected.
	 * 
